...
import Moov3AccountModalDel from "./Moov3AccountModalDel";

export default function Moov3Account() {
  const { me } = useMoov3();
  ...
  const onUpdate = (e: React.FormEvent<HTMLFormElement>) => {
    ...
    axios
      ...
      .patch(`${url}/api-mongoose/v3/me`, formData)
      .then((res) => {
    ...
    <div>
      ...
      <form onSubmit={onUpdate} className="mt-3 max-w-lg">
        ...
        <div className="flex justify-between items-center mt-3">
          ...
          <Moov3AccountModalDel openDel={openDel} setOpenDel={setOpenDel} />
        </div>
      </form>
    </div>
  );
