import { Moov3Category, Moov3Tag } from "./typesMoov3";
import { useDebouncedCallback } from "use-debounce";
import { useNavigate, useSearchParams } from "react-router";
import { useEffect, useState } from "react";

export const Moov3ProductsSearch = () => {
...
export const Moov3ProudctsFilterTags = ({ tags }: { tags: Moov3Tag[] }) => {
...
export const Moov3ProductsFilterCategory = ({ categories }: { categories: Moov3Category[] }) => {
  const [searchParams] = useSearchParams();
